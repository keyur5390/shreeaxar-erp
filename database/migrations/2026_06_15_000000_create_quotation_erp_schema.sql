-- Shree Axar Furniture Quotation ERP base schema.
-- This migration is intentionally plain SQL so the lightweight runtime can execute it
-- against SQLite locally and MySQL in Docker/production.
